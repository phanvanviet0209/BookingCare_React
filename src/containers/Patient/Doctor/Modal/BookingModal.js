...
class BookingModal extends Component {
    ...
    render() {
        let { isOpenModal, closeBokingClose, dataTime } = this.props;
        let doctorId = '';
        if (dataTime && !_.isEmpty(dataTime)) {
                    ...
                    >
                        <div className='booking-modal-content'>
                            <div className='booking-modal-header'>
                                ...
                                <span className='right' onClick={closeBokingClose}><i className='fas fa-times'></i></span>
                            </div>
                            ...
                            <div className='booking-modal-footer'>
                                ...
                                <button className='btn-booking-cancel' onClick={closeBokingClose}>
