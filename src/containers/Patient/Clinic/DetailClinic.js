    ...
    render() {
        ...
        return (
            <div className='detail-specialty-container'>
                        ...
                        {dataDetailClinic && !_.isEmpty(dataDetailClinic)
                            ...
                            <>
                                <div className='detail-name'>
                                    <div className='detail-name-body'>

                                        {dataDetailClinic.name}
                                    </div>
                                </div>
                                <div className='description-clinic' dangerouslySetInnerHTML={{ __html: dataDetailClinic.descriptionHTML }}>
                ...
                <div className='infor-body-specialty'>
